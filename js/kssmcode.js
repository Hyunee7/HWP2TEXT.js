...
//        if(j>1) console.log(j);
        ...
        if(findArr.length == 2){
            ...
            if (ch1 >= 64 && ch1 <= 83) { // HWP 한자코드로 변환
                ...
                if(findArr[1]==ch1 && findArr[0]==ch2){
                    isFind=true;
                    break;
                }
            }
...
// ,0xeebd:'利' // 
   ...
   ,0xec44:'穗' // 
   ,0xedeb:'言' // 
   ,0xe4d7:'當' // 当 와 코드가 같음. HERVE8.hwp 확인필
   ,0xeb94:'城' // 
   ,0xf37b:'足' // 
   ,0xf395:'宗' // 
   ,0xee6a:'硏' // 
...
// ,0xf1a1:'春' // 춘
   ...
   ,0xe3a6:'機' // 기
   ,0xe5a9:'絡' // 락
   ,0xf5d0:'椎' // 추 嵒[바위 암] 와 같은 코드. 문선.hwp 확인필 
   ,0xeea5:'曄' // 엽
   ,0xe457:'老' // 노
   ,0xe93d:'瞥' // 별
   ,0xed4f:'岳' // 악
   ...
   ,0xe576:'讀' // 두
   ,0xe436:'娘' // 랑
   ,0xe5d7:'兩' // 양 両 와 같은코드, HERVE8.hwp 확인필
   ,0xe698:'僚' // 료
   ,0xeaee:'庶' // 서
   ,0xf2d5:'廷' // 정
   ,0xe44f:'奴' // 노
